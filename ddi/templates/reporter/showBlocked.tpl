...
{ assign var="view_by_url" value="View by Url" }
{ assign var="view_by_category" value="View by Category" }

<div id="controls">
 {$translations[$start_date]}: <input class="text medium required" size="7" type="text" id="datepickerstart"> 
 {$translations[$end_date]}: <input class="text medium required" size="7" type="text" id="datepickerend"> 
...
<div style="width:540px" id="chart1-blocked">
    <div style="padding:10px;line-height:30px;text-align:center;padding-top:25px;font-size:17px;">
        {$translations[$t_few_data_stats]}
    </div>
</div>
<center><button class='button red' onclick="showBlockedByUrl()">{$translations[$view_by_url]}</button></center>
<br>
<div style="width:540px" id="flex1-blocked">
</div>
</div>
<div id="chart2-wrapper" style="display:none;">
<div style="width:540px;" id="chart2-blocked">
    <div style="padding:10px;line-height:30px;text-align:center;padding-top:25px;font-size:17px;">
        {$translations[$t_few_data_stats]}
    </div>
</div>
<center><button class='button red' onclick="showBlockedByCategory()">{$translations[$view_by_category]}</button></center>
<br>
{$translations[$message_url_detail]}.
<div style="width:540px" id="flex2-blocked">
</div>
</div>
