...
<fieldset>
    <legend>{$translations[$t_manage_applications]}</legend>
    <div class="form-dlp" id="dlp_new_application">
        <form action="?module=dlp&action=createApplication" method="POST" id="new_application_form">
            <p>
                <span class="entitle_medium">{$translations[$t_applications]}:</span>
                <input type="text" class="text medium required" name="application" id="application" value="">
            </p>
            <p>
                <span class="entitle_medium">{$translations[$t_short_desc]}:</span>
                <input type="text" class="text medium required" name="description" id="description" value="">
            </p>
