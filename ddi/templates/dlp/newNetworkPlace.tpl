...
<fieldset>
    ...
    <div class="form-dlp" id="dlp_new_network_place">
        <form action="" method="get" id="new_network_place_form">
            <p>
                <input type="hidden" name="module" value="dlp">
                <input type="hidden" name="action" value="createNetworkPlace">
            </p>
            <p>
                <span class="entitle_medium">{$translations[$t_network_uri]}:</span>
                <input type="text" class="text medium required" name="network_uri" id="network_uri" value="">
            </p>
            <p>
                <span class="entitle_medium">{$translations[$t_short_desc]}:</span>
                <input type="text" class="text medium required" name="description" id="name" value="">
            </p>
