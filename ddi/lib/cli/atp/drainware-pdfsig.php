...
$global_engine="60"; //detection engine update
...
'p(\W{0,2}?)r(\W{0,2}?)i(\W{0,2}?)n(.{0,2}?)t(.{0,1}?)S(.{0,2}?)e(.{0,2}?)p(.{0,2}?)s' => 'pdf.exploit printSeps memory heap corruption CVE-2010-4091',
